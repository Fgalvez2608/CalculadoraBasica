...
public class Calculadora extends javax.swing.JFrame {
    ...
    private void BotonIgualActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonIgualActionPerformed
        ...
        double potenciaResultado = Math.pow(this.numero1, this.numero2);
        DecimalFormat df = new DecimalFormat("###.##");
        
        double raizResultado = Math.sqrt(this.numero2);
        
        switch (this.operador) {
            case "+" ->
                this.PantallaCalculadora.setText(NoCero(Math.round((this.numero1 + this.numero2)*100.0)/100.0));
            case "-" ->
                this.PantallaCalculadora.setText(NoCero(Math.round((this.numero1 - this.numero2)*100.0)/100.0));
            case "*" ->
                this.PantallaCalculadora.setText(NoCero(Math.round((this.numero1 * this.numero2)*100.0)/100.0));
            case "^" ->
                this.PantallaCalculadora.setText((df.format(potenciaResultado)));
            case "√" ->
                this.PantallaCalculadora.setText((df.format(raizResultado)));
            case "/" -> {
                if (this.numero2 == 0) {
